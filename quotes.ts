...
export const QUOTES: Quote[] = [
  ...
  {
    quote: "Yield not to disasters, but press onward the more bravely.",
    author: "Virgil",
  },
  {
    quote:
  ...
  {
    quote: "Creation is a drug I cannot do without.",
    author: "Cecil B. DeMille",
  },
  { quote: "What we build, builds us.", author: "Anonymous" },
  {
    quote:
  ...
  { quote: "To create is to live twice.", author: "Albert Camus" },
  {
    quote:
  ...
  { quote: "A path is made by walking on it.", author: "Zhuangzi" },
  { quote: "Commitment is an act, not a word.", author: "Jean-Paul Sartre" },
  {
    quote:
  ...
  {
    quote: "To conquer oneself is the best and noblest victory.",
    author: "Plato",
  },
  {
    quote:
